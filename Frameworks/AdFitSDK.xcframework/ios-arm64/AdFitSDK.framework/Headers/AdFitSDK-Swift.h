...
@interface AdFitFlexibleView : UIView
...
@property (nonatomic) CGFloat desiredMediaWidth;
- (nonnull instancetype)initWithAdUnitId:(NSString * _Nonnull)adUnitId preload:(BOOL)preload OBJC_DESIGNATED_INITIALIZER;
- (void)loadAd;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
